...
cv2.putText(img,"Mercury",(100,250),fontFace=cv2.FONT_HERSHEY_COMPLEX,fontScale=0.5,color=(225,225,255))
cv2.putText(img,"Venus",(150,280),fontFace=cv2.FONT_HERSHEY_COMPLEX,fontScale=0.5,color=(225,225,255))
